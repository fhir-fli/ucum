...
void main() {
  group('UcumDecimal division', () {
    test('10.0 / 4 should equal 2.5', () {
      ...
      final b = UcumDecimal.fromString('4');
    ...
    test('10 / 4 should equal 2.5', () {
      final a = UcumDecimal.fromString('10');
      final b = UcumDecimal.fromString('4');
      final result = a.divide(b);
      print('10 / 4 = $result');
      expect(result.comparesTo(UcumDecimal.fromString('2.5')), equals(0));
    ...
    test('5.0 / 2.0 should equal 2.5', () {
      final a = UcumDecimal.fromString('5.0');
      final b = UcumDecimal.fromString('2.0');
      final result = a.divide(b);
  ...
  group('UcumDecimal division precision tracking', () {
    test('10 / 3 should have 2 significant digits', () {
      final a = UcumDecimal.fromString('10');
      final b = UcumDecimal.fromString('3');
      final result = a.divide(b);
      print('10 / 3 = $result');
    ...
    test('10.00 / 3 should have 4 significant digits', () {
      final a = UcumDecimal.fromString('10.00');
      final b = UcumDecimal.fromString('3');
      final result = a.divide(b);
    ...
    test('10.00 / 3.0 should have 2 significant digits', () {
      final a = UcumDecimal.fromString('10.00');
      final b = UcumDecimal.fromString('3.0');
      final result = a.divide(b);
  ...
  group('UcumService division', () {
    ...
    test('divideBy: 10.0 mg / 4 mg should be 2.5', () {
      final o1 = Pair(value: UcumDecimal.fromString('10.0'), unit: 'mg');
      final o2 = Pair(value: UcumDecimal.fromString('4'), unit: 'mg');
      final result = ucumService.divideBy(o1, o2);
