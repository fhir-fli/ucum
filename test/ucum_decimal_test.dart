...
void main() {
  group('testAsInteger', () {
    const message = 'Failed to round trip the integer ';
  ...
  group('testCompares', () {
    test('testCompares', () {
      ...
      var message = getCompareMessage('1', '1', 0, result);
  ...
  group('testSubtract', () {
    test('testSubtract', () {
      ...
      var message = getAddSubMessage('2', '1', '1', '-', res);
      expect('1', res.asUcumDecimal(), reason: message);
  ...
  group('testMultiply', () {
    test('testMultiply', () {
      ...
      var message = getAddSubMessage('2', '2', '4', '*', res);
  ...
  group('testDivide', () {
    test('UcumDecimal Divide', () {
      ...
      var message = getAddSubMessage('500', '4', '125', '/', res);
    ...
    test('Integer Divide', () {
      ...
      var message = getAddSubMessage('500', '4', '125', '/(int)', res);
      expect('125', res.asUcumDecimal(), reason: message);
      res = UcumDecimal.fromString('1260257')
  ...
  group('testModulo', () {
    test('testModulo', () {
      ...
      var message = getAddSubMessage('10', '1', '0', '%', res);
      expect('0', res.asUcumDecimal(), reason: message);
...
void testRounding(String value, String expected) {
  final dec = UcumDecimal.fromString(value)..checkForCouldBeWholeNumber();
